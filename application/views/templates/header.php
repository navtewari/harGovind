                    ...
                    <div class="header-top-right">
                        <div class="login_box">
                            <div id="loginContainer">
                                ...
                                <div id="loginBox">                                    
                                    <form id="loginForm" action="https://www.google.com/search" class="searchform" method="get" name="searchform" target="_blank">
                                        <div class="search_box">
                                            <input name="sitesearch" type="hidden" value="hargovindsuyal.org/">                                            
                                            <input required name="q" type="text" value="Search" onfocus="this.value = '';" onblur="if (this.value == '') {
                                                        this.value = 'Search';
                                                    }">
